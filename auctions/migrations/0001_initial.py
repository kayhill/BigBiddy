# Generated by Django 3.0.8 on 2020-07-21 18:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TR', 'Travel'), ('FD', 'Food'), ('CL', 'Clothing'), ('AV', 'Adventure'), ('OT', 'Other')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment', to='auctions.Listing')),
